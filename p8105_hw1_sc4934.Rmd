...
I was able to convert the logical variable as it can be converted to a 1 or 0 depending of if it is true or false. I was able to to take the mean before converting it to numeric as R recognized the 1 and 0 values.  
